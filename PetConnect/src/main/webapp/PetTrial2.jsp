...
else if(cat.trim().equals("female"))
{
	Product = pd.getProductByGender(cat);
	count = pd.getProductCount();
}
else if(cat.trim().equals("male"))
{
	Product = pd.getProductByGender(cat);
	count = pd.getProductCount();
}
else 
   {
	...
	Product = pd.getProductByCatId(cid);
    count = pd.getProductCountbyId();
   }
...
<div class="container">
    ...
    <a data-toggle="collapse" data-target="#collapse_1" aria-expanded="true" >
        <h6 class="title">Category</h6> 
     
    </a>
</header>
		<div class="filter-content collapse show" id="collapse_1" class="collapse show" >
			<div class="card-body">
				
				
				<ul class="list-menu">
				 <li><a href="PetTrial2.jsp?category=all" class=" c-link list-group-item list-group-item-action" >All</a></li>
				<%
				
				for(Category pt:Category){
					
				%>
				<li><a href="PetTrial2.jsp?category=<%=pt.getcid()%>"  class=" c-link list-group-item list-group-item-action"><%= pt.getName()%></a></li>
				<%                }
    ...
    <a data-toggle="collapse" data-target="#collapse_1" aria-expanded="true" >
		...
		<div class="filter-content collapse show" id="collapse_1" class="collapse show" >
			<div class="card-body">
				...
				<li><a href="PetTrial2.jsp?category=male"  class=" c-link list-group-item list-group-item-action">Male</a></li>
				<li><a href="PetTrial2.jsp?category=female"  class=" c-link list-group-item list-group-item-action">Female</a></li>
		...
		<div class="filter-content collapse show" id="collapse_4" style="">
			<div class="card-body">
			  <label class="checkbox-btn">
			    ...
			    <span href="PetTrial2.jsp?gender=" class=" c-link list-group-item list-group-item-action">Male</span>
			   
			  </label>

			  <label class="checkbox-btn">
			    <input type="checkbox">
			    <span href="PetTrial2.jsp?gender=" class=" c-link list-group-item list-group-item-action">Female</span>
...
<!--  	<article class="filter-group">
		<header class="card-header">
		<!--  	<a data-toggle="collapse" data-target="#collapse_5" aria-expanded="false" class="data-toggle">
				<i class="icon-control fa fa-chevron-down"></i>
				<h6 class="title">More filter </h6>
			</a> 
			<a class="" data-toggle="collapse" data-target="#collapse_5" aria-expanded="false">
    <i class="icon-control fa fa-chevron-down"></i>
    <h6 class="title">More filter </h6>
</a>
		</header>
